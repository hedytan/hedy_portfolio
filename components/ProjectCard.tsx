  ...
  return (
    <div>
      <Link
        ...
        className="relative block overflow-hidden no-underline rounded-[26px] bg-amber border border-white/[0.06] h-[520px] md:h-[540px] shadow-[0_24px_60px_rgba(0,0,0,0.55)]"
      >
        {/* header (always visible) */}
        <div className="absolute top-0 inset-x-0 z-30 px-7 md:px-10 pt-8 flex justify-between items-center">
          <span className="font-mono text-[13px] tracking-wide text-[#EDE1D3] flex items-center">
        ...
        <div className={`absolute inset-0 z-10 transition-opacity duration-500 ${hovered ? "opacity-0" : "opacity-100"}`}>
          ...
          <div className="hidden md:block h-full">
            ...
            <div className="absolute inset-y-0 right-0 w-[52%] flex items-center pr-14">
              <div>
                ...
                <p className="mt-5 text-[#EDE1D3] text-lg leading-relaxed max-w-[42ch]">
                  {project.description}
                </p>
                {project.highlight && (
                  <p className="mt-4 font-mono text-[12px] tracking-[.1em] uppercase text-[#EDE1D3]/75">
                    {project.highlight}
                  </p>
                )}
              </div>
          ...
          <div className="md:hidden flex flex-col h-full pt-24 px-7">
            <div>
              ...
              <p className="mt-4 text-[#EDE1D3] text-base leading-relaxed">
                {project.description}
              </p>
              {project.highlight && (
                <p className="mt-3 font-mono text-[11px] tracking-[.1em] uppercase text-[#EDE1D3]/75">
                  {project.highlight}
                </p>
              )}
            </div>
